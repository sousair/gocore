...
func (l myLogger) Info(ctx context.Context, msg string, data ...any)  {}
func (l myLogger) Warn(ctx context.Context, msg string, data ...any)  {}
func (l myLogger) Error(ctx context.Context, msg string, data ...any) {}
